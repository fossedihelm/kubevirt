...
var _ = Describe("Workload Updater", func() {
	...
	BeforeEach(func() {
		...
		controllerExecutor = watchtesting.NewControllerExecutor(controller, controller.vmiStore, controller.podIndexer, controller.migrationStore, controller.kubeVirtStore)
	})
